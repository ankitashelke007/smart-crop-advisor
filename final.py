...
# Load Crop Dataset
data = pd.read_csv(r"C:\Users\Ankita\Desktop\projects\combine_crop\Crop-Recomedation\Dataset\Crop_Recommendation.csv")
...
# 🍃 Mango & Tomato Disease Detection
...
def predict1():
    ...
    if request.method == 'POST':
        try:
            ...
            return render_template('predict1.html', prediction_text="Invalid input values!")
